...
***REMOVED***
# Create test token
***REMOVED*** -X POST https://YOUR_PROJECT.supabase.co/rest/v1/rpc/create_unsubscribe_token \
  -H "Authorization: Bearer YOUR_KEY" \
  -H "Content-Type: application/json" \
  -d '{"p_email": "test@example.com", "p_email_type": null}'

# This returns a token like: "your_removed_credential_here"

# Visit unsubscribe page
# https://nerve-store.com/unsubscribe?token=your_removed_credential_here
```
...
-- Returns: "your_removed_credential_here"
```
...
SELECT process_unsubscribe(
  p_token := 'your_removed_credential_here',
