...
- [ ] Add all VITE\_ variables listed above
...
4. Add all VITE\_ variables from table above
5. Save
...
***REMOVED***
# Test main page
***REMOVED*** https://www.nerveey.shop
...
### Error: "Environment variables undefined (VITE\_ not set)"
