...
const FAQ_RESPONSES: Record<string, string> = {
  // Shipping & Delivery
  shipping:
    'We offer standard delivery (2-5 business days) and express delivery (next day) across Egypt. Shipping costs vary by location and order value.',
  delivery:
    'Standard delivery takes 2-5 business days. Express delivery is available for next-day delivery in Cairo and Alexandria.',
  track:
    'You can track your order from your account page under "Order History" or use the tracking link sent to your email.',

  // Returns & Exchanges
  return:
    'We offer free returns within 14 days of delivery. Items must be unworn with tags attached. Visit our Returns page for more details.',
  exchange:
    'Exchanges are available within 14 days. You can exchange for a different size or color based on availability.',
  ...
  sizing:
    'Our size guide shows measurements for each item. For the best fit, measure yourself and compare with our guide.',
  material:
    'We use premium cotton, sustainable denim, and high-quality fabrics. Material details are listed on each product page.',
  ...
  cancel:
    'Orders can be cancelled within 2 hours of placement. Contact us immediately if you need to cancel.',
  ...
  contact:
    'You can reach us via this chat, email at support@nerve.store, or through our contact page.',
};
