  ...
  return (
    <div className="rounded-2xl border border-navy/10 bg-mist/30 px-6 py-10 text-center">
      ...
      {actionLabel && onAction ? (
        <button
          onClick={onAction}
          className="mt-5 inline-flex items-center justify-center rounded-full border border-navy px-5 py-2 text-sm font-medium text-navy hover:bg-navy hover:text-white transition-colors"
        >
          {actionLabel}
        </button>
      ) : null}
