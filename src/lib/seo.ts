...
export function generateOrganizationSchema() {
  return {
    ...
    '@type': 'Organization',
    name: 'NERVE',
    description: 'Cool but Chic - Egyptian concept store for modern streetwear',
    url: 'https://nerve.store',
    logo: 'https://nerve.store/logo.png', // Replace with actual logo URL
    sameAs: [
      'https://instagram.com/nerve_store', // Replace with actual social links
      'https://facebook.com/nerve.store',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
      telephone: '+20-xxx-xxx-xxxx', // Replace with actual phone
      contactType: 'Customer Service',
      email: 'support@nerve.store',
    },
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'EG',
      addressRegion: 'Cairo', // Replace with actual address
    },
  }
}
...
export const DEFAULT_SEO = {
  ...
  description: 'Discover NERVE\'s collection of modern streetwear. From premium tees to sustainable denim, find your style in our carefully curated Egyptian concept store.',
  image: 'https://nerve.store/og-image.jpg', // Replace with actual image
  url: 'https://nerve.store',
...
export const seoHelpers = {
  ...
  home: (): SEOProps => ({
    ...
    description: 'Shop the latest in Egyptian streetwear at NERVE. Premium tees, hoodies, and sustainable denim. Free delivery across Egypt.',
  }),
  ...
  shop: (): SEOProps => ({
    ...
    description: 'Browse our complete collection of streetwear. Tees, hoodies, denim and more. Free shipping on orders over EGP 500.',
  }),

  // Product page
  product: (product: { name: string; description: string; price: number; images: string[]; category?: string }): SEOProps => ({
  ...
  category: (categoryName: string, description?: string): SEOProps => ({
    ...
    description: description || `Shop ${categoryName.toLowerCase()} from NERVE. Modern Egyptian streetwear with free delivery across Egypt.`,
  }),
}