...
function StorefrontChrome({
  ...
  return (
    <>
      ...
      {!chatbotOpen && <ChatbotTrigger onClick={() => setChatbotOpen(true)} />}
    </>
  )
}
...
export default function App() {
  ...
  const routes = (
    <Routes>
      ...
      <Route path="/shop" element={<Suspense fallback={<SimpleSkeleton />}><Shop /></Suspense>} />
      <Route path="/product/:slug" element={<Suspense fallback={<SimpleSkeleton />}><ProductDetail /></Suspense>} />
      ...
      <Route path="/account" element={<ProtectedRoute><Suspense fallback={<SimpleSkeleton />}><Account /></Suspense></ProtectedRoute>} />
      <Route path="/account/orders" element={<ProtectedRoute><Suspense fallback={<SimpleSkeleton />}><AccountOrders /></Suspense></ProtectedRoute>} />
      <Route path="/account/orders/:id" element={<ProtectedRoute><Suspense fallback={<SimpleSkeleton />}><AccountOrderDetail /></Suspense></ProtectedRoute>} />
      <Route path="/account/addresses" element={<ProtectedRoute><Suspense fallback={<SimpleSkeleton />}><AccountAddresses /></Suspense></ProtectedRoute>} />
      <Route path="/account/wishlist" element={<ProtectedRoute><Suspense fallback={<SimpleSkeleton />}><AccountWishlist /></Suspense></ProtectedRoute>} />
        ...
        element={
          <Suspense fallback={<AdminFallback />}>
            <Routes>
              ...
              <Route path="products/:id" element={<AdminRoute><AdminProductForm /></AdminRoute>} />
              ...
              <Route path="customers/:id" element={<AdminRoute><AdminCustomerDetail /></AdminRoute>} />
              <Route path="contacts" element={<AdminRoute><AdminContacts /></AdminRoute>} />
              <Route path="newsletter" element={<AdminRoute><AdminNewsletter /></AdminRoute>} />
              <Route path="payments" element={<AdminRoute><AdminPayments /></AdminRoute>} />
        ...
        <WishlistProvider>
          <ToastProvider>
            {isAdminRoute ? (
              ...
              <StorefrontChrome loading={loading} setLoading={setLoading} searchOpen={searchOpen} setSearchOpen={setSearchOpen}>
                {routes}
              </StorefrontChrome>
            )}
          </ToastProvider>
