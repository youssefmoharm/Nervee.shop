  ...
  return (
    <div data-testid="cart-test">
      ...
      <button 
        ...
        onClick={() => cart.addLine(testProduct)}
      >
        Add Item
      </button>
      ...
      <button 
        ...
        onClick={() => cart.removeLine('product-1', 'Black', 'M')}
      >
        Remove Item
      </button>
      ...
      const CartWithVariants = () => {
        ...
        return (
          <div>
            ...
            <button onClick={() => cart.addLine(product1)}>Add Black M</button>
            <button onClick={() => cart.addLine(product2)}>Add Red M</button>
            <button onClick={() => cart.removeLine('product-1', 'Black', 'M')}>Remove Black M</button>
          </div>
        )
      }
      ...
      const CartWithNegativeQuantity = () => {
        ...
        return (
          <div>
            ...
            <button onClick={() => cart.updateQuantity('product-1', 'Black', 'M', -5)}>Set Negative</button>
            <button onClick={() => cart.updateQuantity('product-1', 'Black', 'M', 0)}>Set Zero</button>
          </div>
        )
      }
