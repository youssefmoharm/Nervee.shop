...
-- Run these to verify the email automation system is set up correctly
...
-- 7. Recent email attempts?
-- Query #13 above (check for error messages)

-- 8. Edge Function errors?
-- Check Edge Function logs in Supabase dashboard

-- 9. Secrets set?
-- Check Settings > Secrets in Supabase dashboard
